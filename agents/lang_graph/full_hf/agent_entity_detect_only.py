...
def main():
    ...
    prompt_column = construct_llama_prompt(analysis_system_prompt, extract_direct_entity_prompt)
    ...
    questions.to_csv('out/out_matches_only.csv', index=False)
